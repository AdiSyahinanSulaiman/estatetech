...
List<Property> globalProperties = [
  Property(
    ...
    sellerId: 'admin_1',
    sellerName: 'EstateTech Admin',
    sellerPhoto: 'https://ui-avatars.com/api/?name=Admin&background=random',
    isSaved: false,
  ),
  Property(
    id: '2',
    ...
    sellerId: 'admin_2',
    sellerName: 'Urban Agent',
    sellerPhoto: 'https://ui-avatars.com/api/?name=Urban+Agent&background=random',
    isSaved: false,
  ),
];